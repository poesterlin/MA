\chapter{Literature Research Results}
...
\begin{table}[h!]
   ...
   \cmidrule(r){1-1}\cmidrule(lr){2-2}\cmidrule(l){3-3}
    ...
    \raisebox{-\totalheight}{
        \includegraphics[width=0.3\textwidth]{figures/indexinfo.jpg}
    }
    ...
    \raisebox{-\totalheight}{
        \includegraphics[width=0.3\textwidth]{figures/palminfo.jpg}
    }
    ...
    \raisebox{-\totalheight}{
        \includegraphics[width=0.3\textwidth]{figures/triangleinfo.jpg}
    }
