...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/ueq index.pdf}
    \caption{UEQ questionnaire scores of index gesture.}
    \label{fig:ueqIndex}
\end{figure}
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/ueq palm.pdf}
    \caption{UEQ questionnaire scores of index gesture.}
    \label{fig:ueqPalm}
\end{figure}
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/ueq triangle.pdf}
    \caption{UEQ questionnaire scores of index gesture.}
