...
The individual results of the NASA-TLX and the UEQ questionnaires, as well as the overall results are not statistically significant. The overall scores favour the triangle gesture but not to a point that could be considered significantly better than the other gestures. 
