...
the Oculus Quest 2 VR headset. It has a hand-tracking build in, which can
be accessed using the Oculus SDK in Unity. The exact technology the
Oculus Quest device uses are not known. However, it can be speculated that
...
areas, the hands are visible for at least two up to 4 cameras. The
